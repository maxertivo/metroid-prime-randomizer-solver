...
This application checks logs generated by Claris's Metroid Prime Randomizer to see if they are completable. It works for warp and/or elevator randomization. Also works for vanilla randomization.
...
* Medium
    ...
    * Get out of various water in Far Phendrana without Gravity Suit
...
* Expert
    ...
    * Go out of bounds in Ice Ruins West using Bombs and wallcrawl to anywhere in Far Phendrana if necessary
