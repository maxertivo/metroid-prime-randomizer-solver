...
This application checks logs generated by Claris's Metroid Prime Randomizer to see if the seeds are completable. It works for warp and/or elevator randomization. Also works for vanilla randomization.
